...
class TopMenu:
    ...
    def __render_save_info(
        self, rect_width: int, label: str, value: int, position: int, font: Font
    ):
        ...
        text = font.render(f"{value} / {self.total_chapters}", True, "black")
    ...
    def __progress_info(self):
        ...
        font = Font(None, 24)
        text = font.render(f"{self.progress_percent}%", True, "black")
