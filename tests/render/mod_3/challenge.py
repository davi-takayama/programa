...
class TestChallenge(unittest.TestCase):
    ...
    def test_audio_retrieval_without_frequency(self):
        self.challenge.queue.get.return_value = None
        self.challenge.get_audio()
        self.assertEqual([("P", 0)], self.challenge.played)
    ...
    def test_threshold_meet_with_audio_below_mean(self):
        audio = [('A', 0.4), ('B', 0.3), ('C', 0.2)]
        mean_vol_threshold = 0.5
        result = Challenge.find_threshold_meet(audio, mean_vol_threshold)
    ...
    def test_threshold_meet_with_empty_audio(self):
        audio = []
        mean_vol_threshold = 0.5
        result = Challenge.find_threshold_meet(audio, mean_vol_threshold)
        self.assertEqual([], result)
